...
#define NEURON_AMOUNT_INPUT_EVAL              10 // LAYER_SIZE_INPUT
#define NEURON_AMOUNT_HIDDEN_EVAL             10 // 169
#define NEURON_AMOUNT_OUTPUT_EVAL             1
#define LAYER_AMOUNT_HIDDEN_EVAL              6
#define LAYER_AMOUNT_EVAL                   ( 2 + LAYER_AMOUNT_HIDDEN_EVAL )        // Input, Hidden, and Output

#define WEIGHT_AMOUNT_INPUT_LAYER_EVAL      ( NEURON_AMOUNT_INPUT_EVAL * NEURON_AMOUNT_HIDDEN_EVAL )
#define WEIGHT_AMOUNT_HIDDEN_LAYER_EVAL     ( NEURON_AMOUNT_HIDDEN_EVAL * NEURON_AMOUNT_HIDDEN_EVAL )
#define WEIGHT_AMOUNT_OUTPUT_LAYER_EVAL     ( NEURON_AMOUNT_HIDDEN_EVAL * NEURON_AMOUNT_OUTPUT_EVAL )

#define NEURON_AMOUNT_EVAL                  ( NEURON_AMOUNT_INPUT_EVAL + LAYER_AMOUNT_HIDDEN_EVAL * NEURON_AMOUNT_HIDDEN_EVAL + NEURON_AMOUNT_OUTPUT_EVAL )
#define OUTPUT_LAYER_NEURON_BEGIN_IDX_EVAL  ( NEURON_AMOUNT_INPUT_EVAL + LAYER_AMOUNT_HIDDEN_EVAL * NEURON_AMOUNT_HIDDEN_EVAL )
