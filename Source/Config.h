...
#define WEIGHT_AMOUNT_INPUT_LAYER_EVAL      ( LAYER_SIZE_INPUT_EVAL * LAYER_AMOUNT_HIDDEN_EVAL )
...
#define WEIGHT_AMOUNT_EVAL                  ( WEIGHT_AMOUNT_INPUT_LAYER + ( LAYER_AMOUNT_HIDDEN_EVAL - 1 ) * WEIGHT_AMOUNT_HIDDEN_LAYER + WEIGHT_AMOUNT_OUTPUT_LAYER )
#define OUTPUT_LAYER_WEIGHT_BEGIN_IDX_EVAL  ( WEIGHT_AMOUNT_INPUT_LAYER + ( LAYER_AMOUNT_HIDDEN_EVAL - 1 ) * WEIGHT_AMOUNT_HIDDEN_LAYER )
